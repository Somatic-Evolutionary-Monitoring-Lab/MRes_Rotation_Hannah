...
# Read in ctDNA data with CCF z-scores - Abbosh 2023
ctDNA_data_path <- "data/ctDNA_data_abbosh_pos_multiple.fst"
...
# Calculate REF as ddp - dao
# ddp is "Deep depth,  i.e. the total number of unqiue error controlled reads with at least 5 supporting duplicates alligned to the mutated locus"
# dao is "Deep alternate observations, i.e. the number of unqiue error controlled reads with at least 5 supporting duplicates supporting a mutation"
